...
<code>color: <em>color</em>|initial|inherit;</code>
...
<code>background-color: <em>color</em>|initial|inherit;</code>
...
Standard CSS margins are supported, including specification via longhand and shorthand forms. Margins collapse across block formatting contexts. Detailed documentation is forthcoming.
...
Standard CSS padding is supported, including specification via longhand and shorthand forms. Detailed documentation is forthcoming.
...
<code>font-family: <em>family-name</em>|sans|serif|monospace|initial|inherit;</code>
...
<code>font-size: <em>length</em>|initial|inherit;</code>
...
<code>font-weight: normal|bold|initial|inherit;</code>
...
<code>line-height: normal|<em>number</em>|<em>length</em>|<em>% value</em>|initial|inherit;</code>
...
<code>text-align: left|right|center|<em>% value</em>|initial|inherit;</code>
...
<code>vertical-align: baseline|<em>length</em>|<em>% value</em>|sub|super|middle|initial|inherit;</code>
...
<code>white-space: normal|nowrap|pre|initial|inherit;</code>
